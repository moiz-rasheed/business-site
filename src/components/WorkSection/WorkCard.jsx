...
function WorkCard({ URL, title }) {
  return (
    <div className="aspect-[5/4] max-w-xs relative group cursor-pointer">
      ...
      />
      <div className="absolute inset-0 rounded duration-200 group-hover:bg-[#1291ee] group-hover:bg-opacity-90 text-white flex justify-center items-center flex-col">
